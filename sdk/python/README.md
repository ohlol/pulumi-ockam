...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `ockam` with the `NAME` of your provider.
...
- binary: pulumi-resource-ockam
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-ockam/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-ockam/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-ockam_darwin_amd64_v1
│   └── pulumi-resource-ockam
├── pulumi-ockam_darwin_arm64
│   └── pulumi-resource-ockam
├── pulumi-ockam_linux_amd64_v1
│   └── pulumi-resource-ockam
├── pulumi-ockam_linux_arm64
│   └── pulumi-resource-ockam
├── pulumi-ockam_windows_amd64_v1
│   └── pulumi-resource-ockam.exe
└── pulumi-ockam_windows_arm64
    └── pulumi-resource-ockam.exe
```
