module github.com/ohlol/pulumi-ockam/provider

go 1.18

replace (
	github.com/build-trust/terraform-provider-ockam/shim => ./shim
...
require (
	github.com/build-trust/terraform-provider-ockam/shim v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/build-trust/terraform-provider-ockam v0.71.0 // indirect
